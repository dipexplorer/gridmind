...
interface Risk { anomaly_score: number; risk_category: string; expected_lifetime_days: number; model_predictions?: any; shap_values?: ShapRow[]; xgb_shap_values?: ShapRow[]; health_score?: number; }
                ...
                <>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={formattedShap} layout="vertical" margin={{ top: 0, right: 25, left: 10, bottom: 0 }}>
                      ...
                      <YAxis type="category" dataKey="feature" stroke="#64748B" fontSize={11} width={200} tickLine={false} axisLine={false} interval={0} 
